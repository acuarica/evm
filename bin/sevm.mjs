...
void yargs(process.argv.slice(2))
    ...
    .command(
        'decompile <contract>',
        'Decompile the bytecode into Solidity-like source code',
        pos,
        make(decompile)
    )
    .command(
    ...
    .epilog(
        'See https://docs.soliditylang.org/en/latest/abi-spec.html#abi-json for more information regarding the ABI specification.'
    )
    .help().argv;
