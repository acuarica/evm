# contracts/variables/public var set by internal fn

```solidity -no-opt
// SPDX-License-Identifier: UNLICENSED
// Metadata ipfs://QmccpBmZexWrT7sF5kqzEQwNnyvo8a7BiP5RWhnmNaZxhn
...
```mermaid -no-opt
---
title: public var set by internal fn-no-opt
---
flowchart TD
...
```solidity -opt
// SPDX-License-Identifier: UNLICENSED
// Metadata ipfs://QmVm1bdp2MFYnWWS3C3HbJzG6TsXHXNwKZBGEv3Vxb4ysg
pragma solidity 0.7.6;
...
```mermaid -opt
---
title: public var set by internal fn-opt
---
flowchart TD
  classDef state text-align:left
  subgraph cluster_0 ["pc @0"]
