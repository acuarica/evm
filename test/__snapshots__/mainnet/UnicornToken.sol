    ...
    function name() public payable {
        if ((var_1 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff + 0x100 * (0x1 & var_1) == 0) / 0x2) {
            if (0x1f >= (var_1 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff + 0x100 * (0x1 & var_1) == 0) / 0x2) {
                if (0x1f & (var_1 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff + 0x100 * (0x1 & var_1) == 0) / 0x2) {
                    return memory[memory[0x40]:(memory[0x40]+0x20 + (var_1 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff + 0x100 * (0x1 & var_1) == 0) / 0x2 + 0x20 + 0x20 + 0x80 + 0x20 * ((var_1 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff + 0x100 * (0x1 & var_1) == 0) / 0x2 + 0x1f) / 0x20 - (0x1f & (var_1 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff + 0x100 * (0x1 & var_1) == 0) / 0x2) - memory[0x40])];
                }
                return memory[memory[0x40]:(memory[0x40]+(var_1 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff + 0x100 * (0x1 & var_1) == 0) / 0x2 + 0x20 + 0x20 + 0x80 + 0x20 * ((var_1 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff + 0x100 * (0x1 & var_1) == 0) / 0x2 + 0x1f) / 0x20 - memory[0x40])];
            }
