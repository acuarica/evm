    ...
    [
        {
            ...
            members: [
                ...
                /unknown public decimals;/,
                /function name\(\)/,
                /function approve\(address _arg0, uint256 _arg1\)/,
                /function totalSupply\(\)/,
                /function transferFrom\(address _arg0, address _arg1, uint256 _arg2\)/,
                /function withdraw\(uint256 _arg0\)/,
                /function symbol\(\)/,
                /function transfer\(address _arg0, uint256 _arg1\)/,
                /function deposit\(\)/,
            ],
            ercs: ['ERC20'] as const,
        },
